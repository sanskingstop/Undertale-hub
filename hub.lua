...
getgenv().FWRVersion = "Undertale Hub Beta"
...
HumLight.Brightness = 0
  ...
  print('Func Notify')
    ...
    local WelcomeLBL = HomeTB:CreateLabel("Welcome to ".."Undertale Software"..", "..getgenv().DisplayName..".")
    ...
    local RefreshFact = HomeTB:CreateButton({
      ...
      Callback = function()
        ...
        Notify("Undertale Hub", "Fact refreshed!", "Ok")
      end,
    })
    HomeTB:CreateLabel("Undertale License : "..GetLicense())
    HomeTB:CreateLabel("By Sanskingstop")
...
print('Home Tab')
    ...
    if game.PlaceId == 9498006165 then
      ...
      local TeleportBTN = TapTB:CreateButton({
        ...
        Notify("Undertale Hub","Teleported","Ok")
        end,
      })
    ...
    if game.PlaceId == 2092166489 then
      ...
      local GetGunBTN = SurviveTB:CreateButton({
        ...
        Callback = function()
          ...
          Notify("Undertale Hub", "Grabbed Gun!","Ok")
        end,
      })
      local GetAllGunBTN = SurviveTB:CreateButton({
        ...
        Callback = function()
          GetAllGuns()
          Notify("Undertale Hub", "Grabbed all guns","Ok")
        end,
      })
    ...
    if game.PlaceId == 4620170611 then
      ...
      local InfEnergyTB = BreakTB:CreateButton({
        ...
        Callback = function()
          ...
          Notify("Undertale Hub","Applied Infinite Energy.","Ok")
      ...
      local GetMK = BreakTB:CreateButton({
        ...
        Callback = function()
          getItem("MedKit")
          Notify("Undertale Hub", "Got Medkit","Ok")
        end,
      })
      local HealEveryn = BreakTB:CreateButton({
        ...
        game:GetService("ReplicatedStorage").RemoteEvents.BackpackEvent:FireServer(unpack(args))
          ...
          Notify("Undertale Hub","Healed Everyone.","Ok")
      ...
      local Unlockattic = BreakTB:CreateButton({
        ...
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-20.3247604, 18.9970512, -225.763229, 0.999568164, 9.8660152e-08, 0.0293854866, -9.8546721e-08, 1, -5.30829025e-09, -0.0293854866, 2.41015452e-09, 0.999568164)
          Notify("Undertale Hub", "Unlocked Attic","Ok")
        end,
      })
      local unlockbasement = BreakTB:CreateButton({
        ...
        Callback = function()
          ...
          Notify("Undertale Hub","Unlocked basement", "Ok")
        end,
      })
      local getsafecode = BreakTB:CreateButton({
        ...
        Callback = function()
          ...
          Notify("Undertale Hub", "Safe Code : "..getgenv().SafeCodeBIS,"Ok")
        end,
      })
      ...
      local GetItemBTN = BreakTB:CreateButton({
        ...
        Callback = function()
          ...
          if getgenv().SelectedItemBIS == "Breaker" then
            ...
            Notify("Undertale Hub","Grabbed Item!", "Ok")
          end
          Notify("Undertale Hub","Grabbed Item!", "Ok")
          if getgenv().SelectedItemBIS == "" then
            Notify("Undertale Hub","Please select an item","Ok")
          end
    ...
    if game.PlaceId == 155615604 then
      ...
      local NutralTem = PrisonTB:CreateButton({
        ...
        Callback = function()
          ...
          Notify("Undertale Hub", "Joined Neutral team.", "Ok")
        end,
      })
    end
    ...
    if game.PlaceId == 3956818381 then
      ...
      local UnlockAllIsland = NinjaTB:CreateButton({
        ...
        Callback = function()
          ...
          Notify("Undertale Hub", "Unlocked All Islands", "Ok")
        end,
      })
    end
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-126.71673583984375, 47.44757843017578, 10.025036811828613)
          Notify("Undertale Hub", "Teleported to map", "Ok")
        end,
      })
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-322.8427734375, 179.64755249023438, 330.88623046875)
          Notify("Undertale Hub", "Teleported to Lobby", "Ok")
        end,
      })
      local AntiAfkBTN = NaturalTB:CreateButton({
        ...
        Callback = function()
          ...
          Notify("Undertale Hub", "Anti-AFK applied.", "Ok")
        end,
      })
...
Players.PlayerAdded:Connect(function(plr)
    ...
    local HeadlessBTN = UniversalTB:CreateButton({
      ...
      Callback = function()
        MorphHeadless()
        Notify("Undertale Hub", "Your character is now headless! This is FE and everyone can see it.")
      end,
    })
  ...
  local LightTG = UniversalTB:CreateToggle({
    ...
    Callback = function(Value)
      local Falight = game.Players.LocalPlayer.Character.HumanoidRootPart['UndertaleLight']
      if Value == true then
  ...
  local BLRSL = UniversalTB:CreateSlider({
    ...
    MiscTB:CreateParagraph({Title = "Credits", Content = "Developer : Sanskingstop#1401#4719, \nTester"})
    local CopyDC = MiscTB:CreateButton({
      Name = "Copy Discord Invite",
      Callback = function()
        setclipboard("https://discord.gg/efGAV7bGKx")
        Notify("Undertale Hub", "Discord invite copied to clipboard.")
      end,
    })
        ...
        Rayfield:Notify({
          ...
          Actions = { 
              Accept = {
                  ...
                  Callback = function()
                    saveinstance()
                    Notify("Undertale Hub", "Saved this game's models to your executor's Workspace folder.", "Thanks daddy")
                  end
          },
          Decline = {
            Name = "No",
    ...
    local ClientClickBBTN = MiscTB:CreateButton({
      ...
      Callback = function()
        Notify("Undertale Hub", "Undertale will start preventing kicks for you.")
        local Players = game:GetService("Players")
        ...
        OldNameCall = hookmetamethod(game, "__namecall", function(Self, ...)
            ...
            if tostring(string.lower(NameCallMethod)) == "kick" then
                if getgenv().SendNotifications == true then
                  Rayfield:Notify({
                    Title = "Undertale Hub",
                    Content = "Undertale has prevented a Client Kick for you!",
                    Duration = 6.5,
                    Image = 4483362458,
                    Actions = { 
                        Ignore = {
    ...
    local CharBGBTN = MiscTB:CreateButton({
      ...
      Callback = function()
        Notify("Undertale Hub", "Undertale will start preventing Character Bugs for you.")
        local Players = game:GetService("Players")
        local OldNameCall = nil
        ...
        OldNameCall = hookmetamethod(game, "__namecall", function(Self, ...)
            ...
            if tostring(string.lower(NameCallMethod)) == "remove" then
                if getgenv().SendNotifications == true then
                  Rayfield:Notify({
                    Title = "Undertale Hub",
                    Content = "Undertale has prevented your character from getting bugged.",
                    Duration = 6.5,
                    Image = 4483362458,
                    Actions = { 
                        Ignore = {
    ...
    local SpoofUsername = MiscTB:CreateButton({
      ...
      Callback = function()
        ...
        Notify("Undertale Hub", "Spoofed Current Username.", "Ok")
      end,
    })
    local SpoofAllUsername = MiscTB:CreateButton({
      ...
      Callback = function()
        ...
        Notify("Undertale Hub", "Spoofed All Usernames.", "Ok")
      end,
    })
    local SpoofDisplayName = MiscTB:CreateButton({
      ...
      Callback = function()
        ...
        Notify("Undertale Hub", "Spoofed Displayname.", "Ok")
      end,
    })
    local SpoofUsername = MiscTB:CreateButton({
      ...
      Callback = function()
        ...
        Notify("Undertale Hub", "Spoofed all DisplayNames.", "Ok")
      end,
    })
    

    if _G.Undertale_Config == true then
        ...
        Callback = function(Text)
          if Text == "falcon.system.keysystem.value" then
            local valuekeysys = ConfigTB:CreateToggle({
              ...
              Callback = function(Value)
                if Value == true then
                  Notify("Undertale Hub", "You don't have permission to do this.", "Cancel")
    ...
    if GetLicense() == "Developer 🛠️" then
      ...
      getgenv().ScriptPower = "--Powered by Undertale Software\n"
      local CopyLC = DevTools:CreateButton({
        Name = "Copy Position",
        Callback = function()
          setclipboard(tostring(game.Players.LocalPlayer.Character.HumanoidRootPart.Position))
          Notify("Undertale-Dev", "Copied Position.", "Ok")
        end,
      })
      ...
      local ConvertToCOde = DevTools:CreateButton({
        ...
        Callback = function()
          Notify("Undertale-Dev", "Converting Code..","Ok")
          ...
          wait(1)
          Notify("Undertale-Dev", "Converted code and copied to clipboard", "Ok")
        end,
      })
...
loadstring(game:HttpGet("https://github.com/exxtremestuffs/SimpleSpySource/raw/master/SimpleSpy.lua"))()
      ...
      local SimpleSPEE = DevTools:CreateButton({
        ...
        Callback = function()
          rconsoleclose()
          Notify("Undertale-dev", "Terminated Console", "Ok")
        end,
      })
  ...
  if getgenv().KillAuraPL == true then
    for __,v in ipairs(game.Players:GetChildren()) do
     ...
     if getgenv().SpoofUsernameFW == true then
      ...
      game.Players.LocalPlayer.Name = "Undertale-"..rm
     end
    ...
    if getgenv().SpoofDisplayNameFW == true then
      local rm = math.random(0,100000000)
      game.Players.LocalPlayer.Character.Humanoid.DisplayName = "Undertale-"..rm
    end
    if getgenv(). getgenv().SpoofAllDisplayNamesFW == true then
      local rm = math.random(0,100000000)
      for __,v in ipairs(game.Players:GetChildren()) do
        v.Character.Humanoid.DisplayName = "Undertale-"..rm
      end
    end
